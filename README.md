...
![version](https://img.shields.io/badge/version-0.1.37-8b5cf6)
...
```bash
unzip sahar_0.1.37_single_installer.zip && cd sahar_0.1.37_single_installer && sudo sh install.sh master
```
