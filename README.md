...
![version](https://img.shields.io/badge/version-0.1.29-8b5cf6)
...
```bash
unzip sahar_0.1.29_single_installer.zip && cd sahar_0.1.29_single_installer && sudo sh install.sh
```

برای نصب مستقیم Master:

```bash
unzip sahar_0.1.29_single_installer.zip && cd sahar_0.1.29_single_installer && sudo sh install.sh master
```

برای نصب مستقیم Agent:

```bash
unzip sahar_0.1.29_single_installer.zip && cd sahar_0.1.29_single_installer && sudo sh install.sh agent
```
