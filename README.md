...
![version](https://img.shields.io/badge/version-0.1.64-8b5cf6)
...
- `sahar-installer-v0.1.64.sh` نسخه‌ی versioned همان installer برای آرشیو و rollback
