...
release_json=$(curl -fsSL --retry 3 --retry-delay 2 --connect-timeout 15 --max-time 60 -H 'Accept: application/vnd.github+json' -H 'User-Agent: Sahar/0.1.63' "https://api.github.com/repos/cloudflare/cloudflared/releases/tags/{CLOUDFLARED_VERSION}")
